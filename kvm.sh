...
change_dns_resolver(){
	wget -O /etc/issue.net "https://github.com/bejokun/gretz/raw/master/config/issue.net"
...
wget -O /etc/init.d/shadowsocks "https://github.com/bejokun/gretz/raw/master/config/shadowsocks"
...
install_ovpn(){
	...
	./openvpn-install.sh
	cd /etc/openvpn/
	wget -O /etc/openvpn/openvpn-auth-pam.so https://github.com/bejokun/gretz/raw/master/package/openvpn-auth-pam.so
...
install_screenfetch(){
	wget -O /usr/bin/screenfetch "https://github.com/bejokun/gretz/raw/master/config/screenfetch"
...
install_dropbear(){
	cd
	wget -O /etc/default/dropbear "https://github.com/bejokun/gretz/raw/master/config/dropbear"
...
install_stunnel4(){
	...
	wget -O /etc/stunnel/stunnel.conf "https://github.com/bejokun/gretz/raw/master/config/stunnel.conf"
...
install_squid3(){
	...
	/usr/bin/wget --no-check-certificate -O /etc/squid/squid.conf https://github.com/bejokun/gretz/raw/master/config/squid.conf
...
install_premiumscript(){
	cd /usr/local/bin
	wget -O premium-script.tar.gz "https://github.com/bejokun/gretz/raw/master/package/premium-script.tar.gz"
